...
func HostGroupsGET(store *mysql.DataStore) echo.HandlerFunc {
	return func(ctx echo.Context) error {
		...
		return render(ctx, http.StatusOK, "admin/host_groups", map[string]interface{}{
			"game":         "",
...
// TODO: len check
func HostGroupsPOST(store *mysql.DataStore) echo.HandlerFunc {
	return func(ctx echo.Context) error {
		log := middleware.FromContext(ctx)
		...
		return ctx.Redirect(http.StatusFound, "/admin/hostgroups")
	}
}
