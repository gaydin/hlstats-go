                        ...
                        {{ range .users }}
                            <tr>
                                ...
                                <td><select name="{{ .Username }}_acclevel" style="width:125px">
                                        ...
                                        <option value="80" {{ if eq .AccLevel 80 }}selected="selected"{{ end }}>
                                            Restricted
                                        </option>
                                        <option value="100" {{ if eq .AccLevel 100 }}selected="selected"{{ end }}>
                                            Administrator
                                        </option>
                                    </select></td>
                                <td>
                                    <div class="form-group form-check">
                                        <input type="checkbox" name="{{ .Username}}_delete" class="form-check-input"
                                               value="1">
                                    </div>
                                </td>
                            </tr>
